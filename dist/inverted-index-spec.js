...
var _book2Index = require('../fixtures/book2Index.json');

var _book2Index2 = _interopRequireDefault(_book2Index);
...
describe('Inverted Index tests', function () {
  ...
  describe('Checks if index is properly created', function () {
    it('should return a valid index', function () {
      expect(testInvertedIndex.createIndex('book2.json', _book4.default)).toEqual(_book2Index2.default);
    });
  });
